...
const file_proto_chat_proto_rawDesc = "" +
	"\n" +
	"\x10proto/chat.proto\x12\x05hello\"(\n" +
	...
	"\fHelloService\x122\n" +
	"\x04Chat\x12\x13.hello.HelloRequest\x1a\x11.hello.HelloReply(\x010\x01B\x16Z\x14internal/chat;chatpbb\x06proto3"
...
var file_proto_chat_proto_depIdxs = []int32{
	0, // 0: hello.HelloService.Chat:input_type -> hello.HelloRequest
	1, // 1: hello.HelloService.Chat:output_type -> hello.HelloReply
