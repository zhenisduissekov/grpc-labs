...
const file_proto_greeter_proto_rawDesc = "" +
	...
	"\x0fStreamGreetings\x12\x15.greeter.HelloRequest\x1a\x13.greeter.HelloReply0\x01B\x1cZ\x1ainternal/greeter;greeterpbb\x06proto3"
...
var file_proto_greeter_proto_depIdxs = []int32{
	...
	0, // 1: greeter.Greeter.StreamGreetings:input_type -> greeter.HelloRequest
	1, // 2: greeter.Greeter.SayHello:output_type -> greeter.HelloReply
	1, // 3: greeter.Greeter.StreamGreetings:output_type -> greeter.HelloReply
